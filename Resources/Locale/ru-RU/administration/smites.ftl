...
admin-smite-vox-species-swap-name = Сделать воксом
admin-smite-dwarf-species-swap-name = Сделать дворфом
admin-smite-skilet-species-swap-name = Сделать скелетом
...
admin-smite-skilet-species-swap-description = Меняет расу на Скелета.
admin-smite-vox-species-swap-description = Меняет расу на Вокса.
admin-smite-dwarf-species-swap-description = Меняет расу на Дворфа.
