job-name-warden = опрессор
job-name-security = штурмовик
job-name-cadet = конскрипт
job-name-hos = мародер
...
job-name-captain = главнокомандующий
...
job-name-passenger = чернорабочий
...
JobERTSecurity = Штурмовик безопасности ОБР
JobHeadOfPersonnel = глава персонала
JobHeadOfSecurity = Мародер
JobJanitor = уборщик
JobLawyer = адвокат
...
JobSecurityOfficer = Штурмовик СБ
