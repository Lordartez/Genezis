job-greet-station-name = Добро пожаловать на объект { $stationName }.
...
job-greet-crew-shortages = Поскольку команда этот объект изначально был недоукомплектован, вашей ID-карте был дан дополнительный доступ.
