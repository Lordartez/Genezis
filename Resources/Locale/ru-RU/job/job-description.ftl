...
job-description-brigmedic = Боритесь за жизни своих товарищей в тылу Отдела контроля! Вы - первая и последняя надежда своего отряда. Да благословит вас Гиппократ.
...
job-description-hos = Управляйте своими сотрудниками Отдела контроля и следите за их эффективностью, подавляйте инакомыслие, и обеспечивайте безопасность других глав.
...
job-description-warden = Патрулируйте отдел контроля, следите за тем, чтобы никто не воровал из оружейной, и чтобы все заключённые были оформлены и выпущены по окончании срока.
job-description-zookeeper = Устройте тесты на живых организмах, конечно же ради Триглава.
