...
doc-text-printer-application-appointment-interim =
    ...
    Я, (ФИО), в должности (полное наименование должности), прошу согласовать моё назначение на должность временно исполняющего обязанности Главы (полное наименование отдела)/Главнокомандующего.
    При вступлении в должность обязуюсь следовать Стандартным Рабочим Процедурам и до появления Главы (полное наименование отдела)/Главнокомандующего с Центрального Командования обеспечивать порядок и управление отделом, обеспечивать сохранность вверяемых мне особо ценных предметов и снаряжения.

    По прибытии Главы отдела/Главнокомандующего с Центрального Командования обязуюсь сдать повышенный доступ, особо ценные предметы и снаряжение.
    =============================================
                                ⠀[italic]Место для печатей[/italic]
...
doc-text-printer-order-recognizing-rentience-creature =
    ...
    Существо принято/не принято в качестве Чернорабочийа станции до окончания смены.
    =============================================
                                ⠀[italic]Место для печатей[/italic]
...
doc-text-printer-judgment =
    ...
    Решение приговора Отдела контроля:
