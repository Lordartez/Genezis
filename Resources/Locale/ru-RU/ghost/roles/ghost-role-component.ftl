...
ghost-role-information-ert-security-name = ОБР Штурмовик безопасности
...
ghost-role-information-syndie-disaster-victim-description = Вы - обычный Чернорабочий со станции Синдиката. К несчастью, спасательная капсула закинула вас во вражеский сектор...
