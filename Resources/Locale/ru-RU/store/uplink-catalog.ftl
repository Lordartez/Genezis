...
# Bundles
uplink-meds-bundle-name = Медицинский набор от Interdyne
...
uplink-clothing-conducting-gloves-desc = Выглядят как изолированные перчатки, но удар током нанесёт вам гораздо больше повреждений, чем если бы у вас вообще ничего не было на руках! Лучше всего подойдут в качестве подарка Чернорабочийам, которых вы искренне недолюбливаете.
