...
ent-VendingMachineRestockBooze = набор пополнения АлкоМат
    .desc = Поместите в АлкоМат чтобы начать вечеринку! Не для продажи Чернорабочийам, не достигшим совершеннолетия.
...
ent-VendingMachineRestockSecTech = набор пополнения СБТех
    .desc = Коммунисты берегитесь: подкрепление прибыло! На этикетке написано "ТОЛЬКО ДЛЯ СОТРУДНИКОВ Отдела контроля".
