...
ent-PassengerPDA = КПК чернорабочего
    .desc = Покрыт грязью и пылью
...
ent-SecurityCadetPDA = КПК конскрипта
...
ent-CaptainPDA = КПК главнокомандующего
...
ent-HoSPDA = КПК мародера
    .desc = Носитель данного КПК - закон.
ent-WardenPDA = КПК опрессора
    .desc = Похоже, что на ОС был установлен джейлбрейк.
ent-SecurityPDA = КПК штурмовика
    .desc = Красный, чтобы скрыть пятна крови чернорабочего.
ent-CentcomPDA = КПК Триглава
...
ent-ZookeeperPDA = КПК ксенобиолога
    .desc = Сделано из кожи неизвестного существа. Ого!
...
ent-SeniorOfficerPDA = КПК штурмовика
