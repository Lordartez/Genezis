...
ent-ClothingOuterWinterBar = зимняя куртка бармена
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterCap = зимняя куртка Главнокомандующего
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
...
ent-ClothingOuterWinterHoP = зимняя куртка главы персонала
    .desc = { ent-ClothingOuterWinterCoat.desc }
ent-ClothingOuterWinterHoS = зимняя бронекуртка Мародер
    .desc = Прочная, утилитарная зимняя куртка, предназначенная для защиты Мародер от любых угроз, связанных с бригом и переохлаждением.
ent-ClothingOuterWinterHoSUnarmored = зимняя куртка Мародер
...
ent-ClothingOuterWinterSci = зимняя куртка учёного
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
ent-ClothingOuterWinterSec = зимняя куртка Отдела контроля
    .desc = { ent-ClothingOuterWinterCoatToggleable.desc }
