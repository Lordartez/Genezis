...
ent-ClothingHeadHatBeretSecurity = берет охраны
    .desc = Стильный вариант одежды для сотрудников Отдела контроля.
...
ent-ClothingHeadHatBeretHoS = берет Мародер
    .desc = Чёрный берет с вышитой командирской эмблемой. Для Штурмовиков, которые предпочитают стиль безопасности.
ent-ClothingHeadHatBeretWarden = берет смотрителя
    .desc = Фирменный голубой берет с эмблемой смотрителя. Для Штурмовиков, которые предпочитают стиль безопасности.
...
ent-ClothingHeadHatHoshat = шляпа Мародер
    .desc = Верная фуражка стандартного образца начальника Отдела контроля. Чтобы показать Штурмовикам, кто здесь командует.
...
ent-ClothingHeadHatWarden = фуражка смотрителя
    .desc = Фуражка Штурмовика полиции. Эта фуражка подчёркивает, что вы - ЗАКОН.
...
ent-ClothingHeadHatCapcap = фуражка Главнокомандующего
    .desc = Большая, стильная капитанская фуражка.
ent-ClothingHeadHatCentcomcap = фуражка Центком
    .desc = Экстравагантная, причудливая фуражка Штурмовика Центрального командования.
