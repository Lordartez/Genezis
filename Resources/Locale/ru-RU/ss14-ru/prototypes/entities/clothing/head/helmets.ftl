...
ent-ClothingHeadHelmetERTSecurity = шлем Штурмовика безопасности ОБР
    .desc = Атмосферный шлем, который носят Штурмовикы безопасности отрядов быстрого реагирования Nanotrasen. Имеет красный фонарь.
