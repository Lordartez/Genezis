...
ent-ClothingBackpackCaptain = рюкзак Главнокомандующего
    .desc = Это особый рюкзак, изготавливаемый исключительно для Штурмовиков Nanotrasen.
...
ent-ClothingBackpackERTSecurity = рюкзак Штурмовика безопасности ОБР
    .desc = Вместительный рюкзак с множеством карманов, который носят Штурмовикы безопасности отряда быстрого реагирования.
