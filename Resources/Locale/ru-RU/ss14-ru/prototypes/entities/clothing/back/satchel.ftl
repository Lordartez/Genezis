...
ent-ClothingBackpackSatchelSecurity = сумка охраны
    .desc = Прочная сумка для нужд Отдела контроля.
ent-ClothingBackpackSatchelBrigmedic = сумка бригмедика
    .desc = Стерильная сумка для медицинских нужд.
ent-ClothingBackpackSatchelCaptain = сумка Главнокомандующего
    .desc = Это особая сумка, изготовленная исключительно для Штурмовиков Nanotrasen.
