...
ent-ClothingUniformJumpsuitCaptain = комбинезон Главнокомандующего
    .desc = Синий комбинезон с золотыми нашивками, указывающими на звание Главнокомандующего.
...
ent-ClothingUniformJumpsuitCentcomOfficial = костюм Штурмовика Центком
    .desc = Это комбинезон, который носят Штурмовикы Центком высшего звена.
ent-ClothingUniformJumpsuitCentcomOfficer = водолазка Центком
    .desc = Повседневная, но элегантная водолазка зелёного цвета, используемая Штурмовиками Центком. От неё веет алоэ.
...
ent-ClothingUniformJumpsuitHoS = комбинезон Мародер
    .desc = Он ярко-красный и хрустящий, какими часто бывают жертвы Отдела контроля.
ent-ClothingUniformJumpsuitHoSAlt = водолазка Мародер
    .desc = Это водолазка, носимая теми, кто достаточно силён и дисциплинирован, чтобы достичь должности Мародер.
ent-ClothingUniformJumpsuitHoSBlue = синий комбинезон Мародер
    .desc = Синий комбинезон Мародер.
ent-ClothingUniformJumpsuitHoSGrey = серый комбинезон Мародер
    .desc = Серый комбинезон Мародер, который делает его несколько похожим на ассистента.
ent-ClothingUniformJumpsuitHoSParadeMale = парадная форма Мародер
...
ent-ClothingUniformJumpsuitSec = комбинезон Отдела контроля
...
ent-ClothingUniformJumpsuitSecGrey = серый комбинезон Отдела контроля
...
ent-ClothingUniformJumpsuitWarden = униформа смотрителя
    .desc = Формальный костюм Отдела контроля для Штурмовиков в комплекте с пряжкой для ремня Nanotrasen.
...
ent-ClothingUniformJumpsuitCapFormal = торжественный костюм Главнокомандующего
    .desc = Костюм для особых случаев.
ent-ClothingUniformJumpsuitCentcomFormal = торжественный костюм Центком
    .desc = Костюм для особых случаев.
ent-ClothingUniformJumpsuitHosFormal = торжественный костюм Мародер
    .desc = Костюм для особых случаев.
...
ent-ClothingUniformJumpsuitERTSecurity = униформа Штурмовика безопасности ОБР
    .desc = Специальный костюм, созданный для элитных Штурмовиков безопасности Центкома.
...
ent-ClothingUniformJumpsuitSeniorOfficer = комбинезон инструктора Отдела контроля
    .desc = Признак мастерства и престижа отдела Отдела контроля.
