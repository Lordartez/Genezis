...
ent-ClothingBeltSecurity = пояс охраны
    .desc = Может вмещать различное снаряжение Отдела контроля, такое как наручники и вспышки.
ent-ClothingBeltSheath = сабельные ножны
    .desc = Украшенные ножны, предназначенные для хранения Штурмовикского клинка.
...
ent-ClothingBeltSecurityWebbing = РПС охраны
    .desc = Уникальный, универсальный разгрузочный жилет с ремнями и поясом, может вмещать снаряжение Отдела контроля.
