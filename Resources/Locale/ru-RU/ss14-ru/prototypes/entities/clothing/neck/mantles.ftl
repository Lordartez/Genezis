ent-ClothingNeckMantleCap = мантия Главнокомандующего
...
ent-ClothingNeckMantleHOS = мантия Мародер
    .desc = Чешуйчатая мантия, которую можно обернуть вокруг верхней части тела. "Чешуя" символизирует сотрудников Отдела контроля и то, как вы несёте их на своих плечах.
ent-ClothingNeckMantleHOSShoulder = наплечная мантия Мародер
    .desc = Перестрелка с ядерными оперативниками - обычный вторник для этого Мародер. Эта мантия - символ его преданности станции.
