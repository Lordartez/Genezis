ent-ComputerAlert = компьютер атмосферных предупреждений
    .desc = Используется для доступа к системе автоматического оповещения об атмосфере объекта.
...
ent-ComputerCriminalRecords = консоль криминальных записей
    .desc = Её можно использовать для проверки судимостей. Редактировать их может только Отдел контроля.
