...
ent-SignDirectionalSec = знак "Отдел контроля"
    .desc = Указатель в сторону отдела Отдела контроля.
...
ent-SignDirectionalSupply = знак "Департамент внешних операций"
...
ent-SignCargo = знак "снабжение"
    .desc = Знак, указывающий на департамент внешних операций.
...
ent-SignSecurity = знак "Отдел контроля"
    .desc = Знак, изображающий эмблему Отдела контроля.
