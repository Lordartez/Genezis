ent-ClothingHeadCapCentcomBlack = фуражка Штурмовика специальных операций
...
ent-ClothingHeadHatCapWardenAlt = полицейская фуражка смотрителя
    .desc = Специальная синяя фуражка, выдаваемая смотрителю отдела Отдела контроля.
...
ent-ClothingHeadCaptainHat = капитанская шляпа
    .desc = Особая шляпа, сделанная на заказ для Главнокомандующего.
