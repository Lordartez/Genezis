...
ent-ClothingOuterCoatSecurityOvercoat = шинель Отдела контроля
    .desc = Легкобронированная кожаная шинель, предназначенная для повседневной носки высокопоставленными Штурмовиками. Имеет логотип компании Nanotrasen Security.
...
ent-ClothingOuterCoatCaptain = торжественная куртка Главнокомандующего
