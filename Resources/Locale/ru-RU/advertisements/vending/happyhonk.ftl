...
advertisement-happyhonk-6 = Сколько Штурмовиков Отдела контроля требуется чтобы арестовать вас? Трое: один чтобы избить вас до смерти, один чтобы надеть на вас наручники, и один чтобы оттащить ваше тело в техтоннель.
