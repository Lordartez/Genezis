...
cm-gun-use-delay = Вам нужно подождать {$seconds} секунд перед тем как стрелять!
cm-gun-pump-examine = [bold]Нажмите [color=cyan]кнопку уникального действия[/color] (Spacebar по умолчанию) чтобы поднять давление в ружье.[/bold]
cm-gun-pump-first-with = Вам нужно накачать давлением ружье с помощью {$key} для начала!
cm-gun-pump-first = Сначала нужно накачать давление в ружье!
...
rmc-gun-rack-examine = [bold]Нажмите [color=cyan]кнопку уникального действия[/color] (Spacebar по умолчанию) чтобы встать в стойку перед стрельбой.[/bold]
rmc-gun-rack-first-with = Вам нужно встать в стойку с оружием с помощью {$key} кнопки!
rmc-gun-rack-first = Для начала вам нужно встать в стойку!
